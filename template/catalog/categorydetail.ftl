    ...
    <div class="panel-heading">
        <#if productCategory??>
            ...
            <#if searchInCategory?default("Y") == "Y">
                <br/><a href="<@ofbizUrl>advancedsearch?SEARCH_CATEGORY_ID=${productCategory.productCategoryId}</@ofbizUrl>" class="btn btn-default btn-xs">${uiLabelMap.ProductSearchInCategory}</a>
            </#if>
    ...
    <div>
        ...
        <#if productCategoryMembers??>
            ...
            <div
                ...
                <#else>
                    <#if (tabCol?int = 1)><div class="row"></#if>
                    <#if (numCol?int == 1)>
                        <div class="col-md-12">
                    </#if>
                    <#if (numCol?int == 2)>

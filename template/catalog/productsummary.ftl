...
<#if product??>
    ...
    <div class="productsummary">
        <div class="panel-heading">
            <a href="${productUrl}">
                <span id="${productInfoLinkId}" class="popup_link"><img class="img-thumbnail" src="<@ofbizContentUrl>${contentPathPrefix!}${smallImageUrl}</@ofbizContentUrl>" alt="Small Image"/></span>
            </a>
        </div>
        <div id="${productDetailId}" class="popup" style="display:none;">
          <table>
            <tr valign="top">
              <td>
                <img class="img-thumbnail"<@ofbizContentUrl>${contentPathPrefix!}${smallImageUrl}</@ofbizContentUrl>" alt="img-thumbnail"/><br />
        ...
        <div class="productbuy">
          ...
          <#else>
            <form method="post" action="<@ofbizUrl>additem</@ofbizUrl>" name="the${requestAttributes.formNamePrefix!}${requestAttributes.listIndex!}form" style="margin: 0;">
              ...
              <a href="javascript:document.the${requestAttributes.formNamePrefix!}${requestAttributes.listIndex!}form.submit()" class="btn btn-warning">${uiLabelMap.OrderAddToCart}</a>

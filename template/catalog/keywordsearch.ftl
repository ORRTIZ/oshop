...
(C) Copyright 2015 Somonar B.V.
 ...
 -->
<div id="keywordsearch" class="panel panel-default">
    <div class="panel-heading">
        <h3  class="panel-title">${uiLabelMap.ProductProductSearch}</h3>
    </div>
    <div class="panel-body">
    <span class="h2">${uiLabelMap.ProductYouSearchedFor}:</span>
<ul>

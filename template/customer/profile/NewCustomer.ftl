...
<div class="panel panel-default">
    ...
    <h3 class="panel-title">${uiLabelMap.EcommerceMyAccount}</h3>
    </div>
    ...
    <form id="newUserForm" method="post" action="<@ofbizUrl>createCustomerProfile</@ofbizUrl>">
      ...
      <div><a id="submitNewUserForm" href="javascript:void(0);" class="btn btn-default btn-xs">${uiLabelMap.CommonSubmit}</a></div>
    </form>
    </div>
</div>
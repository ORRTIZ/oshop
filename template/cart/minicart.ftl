...
<div id="minicart" class="panel panel-default">
    <div class="panel-heading">
    <h3 class="panel-title">${uiLabelMap.OrderCartSummary}</h3>
    </div>
          ...
          <table>
            <thead>
              <tr>
                ...
                <th align="right">${uiLabelMap.CommonSubtotal}</th>
              </tr>
            </thead>
            <tfoot>
              <tr>
              ...
              <tr>
                <td><strong>${uiLabelMap.OrderTotal}:</strong></td>
                <td>&nbsp;</td>
                <td align="right">
            ...
            <#list shoppingCart.items() as cartLine>
              <tr valign="top">
                <td align="right">${cartLine.getQuantity()?string.number}</td>
                <td>

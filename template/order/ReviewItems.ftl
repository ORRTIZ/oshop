...
<#if baseEcommerceSecureUrl??><#assign urlPrefix = baseEcommerceSecureUrl/></#if>
    <#assign numColumns = 8>
        <#if maySelectItems?default("N") == "Y" && roleTypeId! == "PLACING_CUSTOMER">
            ...
            <a href="javascript:document.addCommonToCartForm.add_all.value='true';document.addCommonToCartForm.submit()" class="btn btn-default">${uiLabelMap.OrderAddAllToCart}</a>
            <a href="javascript:document.addCommonToCartForm.add_all.value='false';document.addCommonToCartForm.submit()" class="btn btn-default">${uiLabelMap.OrderAddCheckedToCart}</a>
            <a href="<@ofbizUrl fullPath="true">createShoppingListFromOrder?orderId=${orderHeader.orderId}&amp;frequency=6&amp;intervalNumber=1&amp;shoppingListTypeId=SLT_AUTO_REODR</@ofbizUrl>" class="btn btn-default">${uiLabelMap.OrderSendMeThisEveryMonth}</a>
        </#if>
<div class="panel">
        ...
        <table width="100%">
            <thead>
                <tr>
                    ...
                    <#if maySelectItems?default("N") == "Y">
                        <td align="right"><strong>${uiLabelMap.OrderQuantity}</strong></td>
                        <td align="right"><strong>${uiLabelMap.OrderQtyPicked}</strong></td>
                        <td align="right"><strong>${uiLabelMap.OrderQuantityShipped}</strong></td>
                        <td align="right"><strong>${uiLabelMap.CommonCancelled}</strong></td>
                    <#else>
                        <th></th>
                        <th></th>
                        <th></th>
                        <td align="right"><strong>${uiLabelMap.OrderQtyOrdered}</strong></td>
                    </#if>
                    <th>&nbsp;</th>
                    <td align="right"><strong>${uiLabelMap.EcommerceUnitPrice}</strong></td>
                    <th>&nbsp;</th>
                    <td align="right"><strong>${uiLabelMap.OrderAdjustments}</strong></td>
                    <th>&nbsp;</th>
                    <td align="right"><strong>${uiLabelMap.CommonSubtotal}</strong></td>
                    <#if maySelectItems?default("N") == "Y" && roleTypeId! == "PLACING_CUSTOMER">
                        <th colspan="3"></th>
                    </#if>
                </tr>
            ...
            <tfoot>
                ...
                <tr align="right">
                    ...
                    <th>&nbsp;</th>
                    <th>&nbsp;</th>
                    <th colspan="7">${uiLabelMap.CommonSubtotal}</td>
                    <td align="right"><strong><@ofbizCurrency amount=orderSubTotal isoCode=currencyUomId/></strong></td>
                ...
                <#list headerAdjustmentsToShow as orderHeaderAdjustment>
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td aling="right"><@ofbizCurrency amount=localOrderReadHelper.getOrderAdjustmentTotal(orderHeaderAdjustment) isoCode=currencyUomId/></td>
                        <#if maySelectItems?default("N") == "Y"><td colspan="3"></td></#if>
                    </tr>
                </#list>
                <tr>
                    ...
                    <td align="right"><@ofbizCurrency amount=orderShippingTotal isoCode=currencyUomId/></td>
                    <#if maySelectItems?default("N") == "Y"><td colspan="3"></td></#if>
                </tr>
                <tr>
                    <th>&nbsp;</th>
                    ...
                    <td align="right"><@ofbizCurrency amount=orderTaxTotal isoCode=currencyUomId/></td>
                    <#if maySelectItems?default("N") == "Y"><td colspan="3"></td></#if>
                </tr>
                <tr>
                    <td colspan="3"></td>
